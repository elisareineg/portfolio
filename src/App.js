        ...
        <div className="about-columns">
          ...
          <div className="about-me-box">
            ...
            <div className="skills-section">
              ...
              <div className="skill-item" data-alt="Linux">
                <svg className="skill-icon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
      ...
      <section className="portfolio-section">
        ...
        <div className="experience-cards-container">
          ...
          <div className="experience-card">
            ...
            <div className="experience-desc">Engineered a GenAI Identity Protection agent using Python scripting and advanced prompt engineering that increased TAM tech touch efficiency by 50-60% and automated complex documentation processes. Spearheaded scalable framework and strategic roadmap for building specialized GenAI agents for Technical Account Managers across all CrowdStrike Falcon modules with consistent knowledge management.</div>
            <div className="experience-skills-row">
              ...
              <span className="experience-skill-bubble">Identity Protection</span>
