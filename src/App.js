    ...
    <div className="App">
      ...
      <div className="hero-container">
        ...
        <div className="geometric-bg">
          {/* JavaScript Logo */}
          <svg className="tech-icon tech-icon-1" xmlns="http://www.w3.org/2000/svg" aria-label="JavaScript" role="img" viewBox="0 0 512 512">
          ...
          {/* HTML5 Logo */}
          <svg className="tech-icon tech-icon-4" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* CSS3 Logo */}
          <svg className="tech-icon tech-icon-5" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Java Logo (additional) */}
          <svg className="tech-icon tech-icon-6" viewBox="0 0 256 346" fill="none">
            <path d="M82.554 267.473s-13.198 7.675 9.393 10.272c27.369 3.122 41.356 2.675 71.517-3.034 0 0 7.93 4.972 19.001 9.279-67.665 28.977-153.219-1.679-99.911-16.517z" fill="#5382A1" />
            <path d="M74.292 229.659s-14.803 10.958 7.805 13.296c29.236 3.018 52.324 3.263 92.276-4.43 0 0 5.526 5.602 14.215 8.666-81.747 23.904-172.798 1.885-114.296-17.532z" fill="#5382A1" />
            <path d="M143.942 165.515c16.66 19.18-4.377 36.44-4.377 36.44s42.301-21.837 22.874-49.183c-18.144-25.567-32.041-38.293 43.228-82.098 0 0-118.238 29.53-61.725 94.841z" fill="#E76F00" />
            <path d="M233.364 295.442s9.767 8.047-10.761 14.273c-39.056 11.827-162.432 15.396-196.714.471-12.323-5.36 10.787-12.8 18.056-14.362 7.581-1.644 11.914-1.346 11.914-1.346-13.705-9.655-88.583 18.957-38.034 27.15 137.853 22.356 251.292-10.066 215.539-26.186z" fill="#5382A1" />
          ...
          {/* React Logo */}
          <svg className="tech-icon tech-icon-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="about-columns">
          ...
          <div className="about-me-box">
            ...
            <div className="skills-section">
              <div className="skill-item" data-alt="Python">
                <svg className="skill-icon" viewBox="0 0 256 256" fill="none">
                  <defs>
                    <linearGradient id="python-gradient-1" x1="12.96%" y1="12.76%" x2="79.39%" y2="78.18%">
                      <stop offset="0%" stopColor="#387EB8" />
                      <stop offset="100%" stopColor="#366994" />
              ...
              <div className="skill-item" data-alt="Java">
                <svg className="skill-icon" viewBox="0 0 256 346" fill="none">
                  <path d="M82.554 267.473s-13.198 7.675 9.393 10.272c27.369 3.122 41.356 2.675 71.517-3.034 0 0 7.93 4.972 19.001 9.279-67.665 28.977-153.219-1.679-99.911-16.517z" fill="#5382A1" />
                  <path d="M74.292 229.659s-14.803 10.958 7.805 13.296c29.236 3.018 52.324 3.263 92.276-4.43 0 0 5.526 5.602 14.215 8.666-81.747 23.904-172.798 1.885-114.296-17.532z" fill="#5382A1" />
                  <path d="M143.942 165.515c16.66 19.18-4.377 36.44-4.377 36.44s42.301-21.837 22.874-49.183c-18.144-25.567-32.041-38.293 43.228-82.098 0 0-118.238 29.53-61.725 94.841z" fill="#E76F00" />
                  <path d="M233.364 295.442s9.767 8.047-10.761 14.273c-39.056 11.827-162.432 15.396-196.714.471-12.323-5.36 10.787-12.8 18.056-14.362 7.581-1.644 11.914-1.346 11.914-1.346-13.705-9.655-88.583 18.957-38.034 27.15 137.853 22.356 251.292-10.066 215.539-26.186z" fill="#5382A1" />
              ...
              <div className="skill-item" data-alt="JavaScript">
                <svg className="skill-icon js-icon" xmlns="http://www.w3.org/2000/svg" aria-label="JavaScript" role="img" viewBox="0 0 512 512">
                  <rect width="512" height="512" rx="15%" fill="#f7df1e" />
                  <path d="M324 370c10 17 24 29 47 29c20 0 33-10 33 -24c0-16 -13 -22 -35 -32l-12-5c-35-15 -58 -33 -58 -72c0-36 27 -64 70 -64c31 0 53 11 68 39l-37 24c-8-15 -17 -21 -31 -21c-14 0-23 9 -23 21c0 14 9 20 30 29l12 5c41 18 64 35 64 76c0 43-34 67 -80 67c-45 0-74 -21 -88 -49zm-170 4c8 13 14 25 31 25c16 0 26-6 26 -30V203h48v164c0 50-29 72 -72 72c-39 0-61 -20 -72 -44z" />
                </svg>
              </div>
              <div className="skill-item" data-alt="TypeScript">
                <img className="skill-icon ts-icon" src="/typescriptlogo.png" alt="TypeScript" />
              </div>
              <div className="skill-item" data-alt="HTML5">
                <svg className="skill-icon html-icon" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6 28L4 3H28L26 28L16 31L6 28Z" fill="#E44D26" />
                  <path d="M26 5H16V29.5L24 27L26 5Z" fill="#F16529" />
                  <path d="M9.5 17.5L8.5 8H24L23.5 11H11.5L12 14.5H23L22 24L16 26L10 24L9.5 19H12.5L13 21.5L16 22.5L19 21.5L19.5 17.5H9.5Z" fill="white" />
                </svg>
              </div>
              <div className="skill-item" data-alt="CSS3">
                <svg className="skill-icon css-icon" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6 28L4 3H28L26 28L16 31L6 28Z" fill="#1172B8" />
                  <path d="M26 5H16V29.5L24 27L26 5Z" fill="#33AADD" />
                  <path d="M19.5 17.5H9.5L9 14L17 11.5H9L8.5 8.5H24L23.5 12L17 14.5H23L22 24L16 26L10 24L9.5 19H12.5L13 21.5L16 22.5L19 21.5L19.5 17.5Z" fill="white" />
                </svg>
              </div>
              <div className="skill-item" data-alt="React">
                <svg className="skill-icon" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M18.6789 15.9759C18.6789 14.5415 17.4796 13.3785 16 13.3785C14.5206 13.3785 13.3211 14.5415 13.3211 15.9759C13.3211 17.4105 14.5206 18.5734 16 18.5734C17.4796 18.5734 18.6789 17.4105 18.6789 15.9759Z" fill="#53C1DE" />
                  <path fillRule="evenodd" clipRule="evenodd" d="
17.4222C22.5677 18.3084 22.9057 19.1657 23.1742 19.9809C22.3043 20.1734 21.3652 20.3284 20.3757 20.4435C21.015 19.4607 21.6149 18.4536 22.1667 17.4222ZM18.7473 20.5941C16.9301 20.72 15.1016 20.7186 13.2838 20.6044C12.2509 19.1415 11.3314 17.603 10.5377 16.0058C11.3276 14.4119 12.2404 12.8764 13.2684 11.4158C15.0875 11.2825 16.9178 11.2821 18.7369 11.4166C19.7561 12.8771 20.6675 14.4086 21.4757 15.9881C20.6771 17.5812 19.7595 19.1198 18.7473 20.5941ZM22.8303 4.4666C24.7006 5.51254 23.8681 9.22726 23.4595 10.8426C22.2149 10.5641 20.8633 10.3569 19.4483 10.2281C18.6239 9.09004 17.7698 8.05518 16.9124 7.15949C18.1695 5.98441 20.9781 3.43089 22.8303 4.4666Z" fill="#53C1DE" />
                </svg>
              </div>
              <div className="skill-item" data-alt="Next.js">
                <svg className="skill-icon" fill="#000000" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="skill-item" data-alt="MySQL">
                <svg className="skill-icon mysql-icon" fill="#ffffff" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                  <title>mysql</title>
              ...
              <div className="skill-item" data-alt="Google Cloud">
                <svg className="skill-icon gcp-icon" viewBox="0 -25 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                  <g>
              ...
              <div className="skill-item" data-alt="Node.js">
                <svg className="skill-icon" viewBox="-3.8 -1.5 40.921 40.921" xmlns="http://www.w3.org/2000/svg">
                  <defs>
      ...
      <section className="portfolio-section">
        ...
        <div className="experience-cards-container">
          ...
          <div className="experience-card">
            ...
            <div className="experience-desc">Engineered GenAI agent for Technical Account Managers using Python scripting and Natural Language Processing with custom prompt engineering, accelerating information retrieval across 15+ knowledge sources and automating complex document synthesis workflows. Spearheaded strategic roadmap development for deploying specialized GenAI agents across all 9 primary CrowdStrike Falcon modules, establishing knowledge management protocols, reusable architecture patterns, and scalable integration frameworks for enterprise-wide adoption.</div>
            <div className="experience-skills-row">
              <span className="experience-skill-bubble">Python</span>
              <span className="experience-skill-bubble">Machine Learning</span>
              <span className="experience-skill-bubble">Natural Language Processing</span>
              <span className="experience-skill-bubble">Account Management</span>
              <span className="experience-skill-bubble">CrowdStrike Falcon</span>
          ...
          <div className="experience-card">
            ...
            <div className="experience-desc">Developed a machine learning model to predict AgeTech adoption success in older adults using scikit-learn, achieving &gt;90% accuracy on a 500-person synthetic dataset with 18 clinical and demographic variables. Designed modular evaluation framework with comprehensive performance metrics (precision, recall, F1-score) across demographic subgroups, featuring SHAP interpretability analysis, automated preprocessing pipeline, RESTful API, and Docker containerization for production deployment.</div>
            <div className="experience-skills-row">
              <span className="experience-skill-bubble">Python</span>
              ...
              <span className="experience-skill-bubble">Docker</span>
              <span className="experience-skill-bubble">REST API</span>
            </div>
          </div>
        </div>
      </section>
